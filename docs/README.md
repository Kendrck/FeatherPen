...
API_MODULE_SPEC.md 端口、函数、接口全局基准
API.md HTTP完整接口手册
...
local_member_config_v1.0.0.json 会员权限配置模板
### 开发细则文档
...
5. 端口区分规则：Web 6554占用自动分配；LLM 1234固定端口
